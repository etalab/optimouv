 ...
 */
class Version20160302155919 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
...
//        $this->addSql('ALTER TABLE poule ADD CONSTRAINT FK_FA1FEB406E9E244D FOREIGN KEY (id_scenario) REFERENCES resultats (id)');
        $this->addSql('ALTER TABLE parametres DROP valeur_exclusion');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE parametres ADD valeur_exclusion INT NOT NULL');
