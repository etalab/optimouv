...
class ActivityListener
{
    ...
    public function __construct(AuthorizationChecker $authorizationChecker, TokenStorage $tokenStorage, EntityManager $manager, $timeLimitActiveUsers)
    {
    ...
    public function onCoreController(FilterControllerEvent $event)
    {
        ...
        if ($this->tokenStorage->getToken()) {
            ...
            $delay = new \DateTime();
            $delay->setTimestamp(strtotime($this->timeLimitActiveUsers." minutes ago"));
