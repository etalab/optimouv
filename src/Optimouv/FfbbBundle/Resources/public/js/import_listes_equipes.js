    ...
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR)
      {
        if(data.success)
        {
          ...
          nouvelleStr = nouvelleStr + '   <a href="renommer-liste-equipes/'+ nouvelElementId +'" class="btn btn-info"> Renommer</a> | ';
          ...
          nouvelleStr = nouvelleStr + '   <a href="visualiser-liste-equipes/'+ nouvelElementId +'" class="btn btn-info"> Visualiser</a> ';
